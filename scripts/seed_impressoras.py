...
def processar_planilha(caminho_planilha: str):
    ...
    try:
        ...
        db.commit()
        print(
            f"✅ Carga concluída! {registros} impressoras injetadas com sucesso no banco de dados."
        )
...
if __name__ == "__main__":
    ...
    if os.path.exists(caminho_arquivo):
        ...
        print(
            f"⚠️ Atenção: O arquivo '{caminho_arquivo}' não foi encontrado na raiz do projeto."
        )
